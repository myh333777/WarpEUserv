...
wget -N -6 https://cdn.jsdelivr.net/gh/myh333777/WarpEUserv/wgcf -O /usr/local/bin/wgcf
wget -N -6 https://cdn.jsdelivr.net/gh/myh333777/WarpEUserv/wireguard-go -O /usr/bin/wireguard-go
...
function up4(){
wget -N --no-check-certificate https://raw.githubusercontent.com/myh333777/WarpEUserv/main/wgmd.sh && chmod +x wgmd.sh && ./wgmd.sh
}

function up6(){
echo -e nameserver 2a00:1098:2c::1 > /etc/resolv.conf
wget -6 -N --no-check-certificate https://raw.githubusercontent.com/myh333777/WarpEUserv/main/wgmd.sh && chmod +x wgmd.sh && ./wgmd.sh
}

#主菜单
function start_menu(){
    clear
    yellow " 详细说明 https://github.com/myh333777/WarpEUserv  YouTube频道：甬哥侃侃侃" 
